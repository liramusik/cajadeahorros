...
$.extend($.validator, {
	...
	messages: {
		...
		dateISO: "Por faovr ingrese una fecha válida (ISO).",
		number: "Por favor ingrese un número válido.",
		digits: "Por favor infrese solo digítos.",
		creditcard: "Por favor ingrese un número de tarjeta de crédito válido.",
		equalTo: "Por favor ingrese nuevamente los datos.",
		...
		rangelength: $.validator.format("Por favor ingrese una longítud de caracteres entre {0} y {1}."),
