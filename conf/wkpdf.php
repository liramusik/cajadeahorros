<?php
        ...
        class WKPDF {
                ...
                public function __construct(){
                        ...
                        do{
                                $this->tmp=$GLOBALS['WKPDF_BASE_TEMP'].mt_rand().'.html';
                ...
                public function render(){
                        $web=$GLOBALS['WKPDF_BASE_TEMP'].basename($this->tmp);
                ...
                public function output($mode,$file){
                        switch($mode){
                                ...
                                case self::$PDF_SAVEFILE:
                                        return file_put_contents($GLOBALS['WKPDF_BASE_TEMP'].$file,$this->pdf);
                                        break;
                                default:
